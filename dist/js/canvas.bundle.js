...
var c = canvas.getContext("2d"); // setting the size of the window

canvas.width = 1024;
canvas.height = 576; //adding the gravity so it may loook realistic

var gravity = 0.5; // defining the player and its properties
...
var scrollOffSet = 0; // lose condition function init 
...
function animate() {
  ...
  if (keys.right.pressed && player.position.x < 400) {
    ...
    player.velocity.x = 0; // moving the platform
...
animate(); // adding eventListeners so that we may get the output based on the key pressed.
